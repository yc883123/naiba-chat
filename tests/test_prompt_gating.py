...
class VisionPromptGatingTests(unittest.TestCase):
    def test_no_vision_tools_no_section(self):
        self.assertEqual(vision_prompt_sections({"read_file", "pwsh"}), [])

    def test_analyze_only_omits_ops(self):
        parts = vision_prompt_sections({"vision_analyze"})
    ...
    def test_analyze_plus_ops_appends_ops_sentence(self):
        parts = vision_prompt_sections({"vision_analyze", "vision_image_ops"})
    ...
    def test_ops_only_gets_standalone_sentence(self):
        parts = vision_prompt_sections({"vision_image_ops"})
