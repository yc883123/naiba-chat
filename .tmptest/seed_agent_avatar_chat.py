...
用法：
    python .tmptest/seed_agent_avatar_chat.py           # 播种（备份 config.json / chat.db）
    python .tmptest/seed_agent_avatar_chat.py --restore  # 还原备份
"""
...
BACKUP_CONFIG = ROOT / ".tmptest" / "config.before_avatar_smoke.json"
BACKUP_DB = ROOT / ".tmptest" / "chatdb.before_avatar_smoke"
