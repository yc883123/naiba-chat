...
// 前置：python .tmptest/seed_turn_rail_chat.py
// 运行：$env:NODE_PATH="<node_modules>"; node .tmptest\_check_turn_rail.cjs
...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: '.tmptest/turn_rail.png' });
