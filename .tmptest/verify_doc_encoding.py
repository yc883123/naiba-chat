...
用法：.venv\\Scripts\\python.exe .tmptest\\verify_doc_encoding.py
...
checks = {
    ...
    "§8.7 指向一键脚本": ".tmptest\\cleanup_tmptest.py" in doc,
}
...
checks[".gitignore 注释无乱码"] = "验证脚本目录：默认忽略" in ignore
checks[".gitignore 默认忽略 .tmptest 产物"] = "\n.tmptest/*\n" in ignore
checks[".gitignore 放行可复用脚本"] = "\n!.tmptest/scan_undef_all.py\n" in ignore
