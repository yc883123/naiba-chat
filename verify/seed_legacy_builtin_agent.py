...
用法：
    python verify/seed_legacy_builtin_agent.py          # 播种（先备份 config.json）
    python verify/seed_legacy_builtin_agent.py --restore # 还原备份
"""
...
BACKUP = ROOT / "verify" / "config.before_agent_smoke.json"
